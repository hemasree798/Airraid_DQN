...
class DQNAgent:
    def __init__(self, input_shape, num_actions, lr=0.0001, gamma=0.95, epsilon=1.0, epsilon_min=0.1, epsilon_decay=0.995, batch_size=32, memory_size=10000, target_update=1000, device="cpu"):
